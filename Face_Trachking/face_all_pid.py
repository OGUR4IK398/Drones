...
def track_face(info, w, pid):
    ...
    f_speed = (pid_f[0] * f_error + pid_f[1] * (f_error - f_p_error)) / 50
    ...
    drone.send_rc_control(0, -f_speed, -h_speed, angle_speed)
    return x_error, y_error, f_error
...
while True:
    ...
    func_res = track_face(info, w, pid)
    x_p_error = func_res[0]
    y_p_error = func_res[1]
    f_p_error = func_res[2]
